...
<div class="h-1/5 flex flex-col gap-6 w-full justify-center">
    ...
    <div id="container" class="overflow-hidden inline-flex flex-nowrap">
        <ul class="flex items-center justify-center md:justify-start [&_li]:mx-8 [&_i]:max-w-none animate-infinite-scroll">
        ...
        <ul class="flex items-center justify-center md:justify-start [&_li]:mx-8 [&_i]:max-w-none animate-infinite-scroll" aria-hidden="true">
            {#each languages as {name, icon}}
                <li>
                    <i id="{name}" class='{icon} text-[120px]'></i>
                </li>
