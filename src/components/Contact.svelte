...
>
	<div class="flex flex-col gap-14 items-center justify-center">
		<h2 class="font-semibold text-5xl relative">
			...
			<!-- Heading skew -->
			<span
				class="-z-10 rounded-sm w-[105%] h-7 bg-purple absolute -bottom-2 -left-3 opacity-80 blur-[1px]"
			></span>
		</h2>
		<div class="flex flex-col justify-center text-xl gap-14 relative">
			...
			<!-- Name input skew -->
			<span
				class="-z-10 rounded-sm w-5/12 h-7 bg-purple absolute top-28 -left-2 opacity-50 blur-[1px]"
			></span>
			<!-- Email input skew -->
			<span
				class="-z-10 rounded-sm w-5/12 h-7 bg-purple absolute top-28 right-5 opacity-50 blur-[1px]"
			></span>
			<!-- Textarea skew -->
			<span
				class="-z-10 rounded-sm w-6/12 h-7 bg-purple absolute top-46 -left-2 opacity-50 blur-[1px]"
			></span>
			<!-- Contact Form -->
			<form
			...
			>
				<div class="flex flex-row gap-14">
					<input
						class="input h-12 p-2 max-w-60 font-semibold text-base"
						type="text"
						name="Name"
						id="nameInput"
						placeholder="Name"
